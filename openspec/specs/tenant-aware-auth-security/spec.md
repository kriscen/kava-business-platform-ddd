# Capability: tenant-aware-auth-security

## Purpose

定义 Auth 模块中多租户感知的安全机制。涵盖 TenantAwareAuthenticationFilter 从 ClientSettings 获取可信租户参数，以及 DBRegisteredClientRepository.findById 的正确行为。

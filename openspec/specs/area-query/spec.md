...
### Requirement: Area tree 作为 Group tree 参考实现
Area tree 端点的实现模式（`TreeBuilder` 使用、节点转换、controller 层调用）SHALL 作为 Group tree 实现的参考模板。

#### Scenario: Group tree 实现遵循 Area tree 模式
- **WHEN** 开发者实现 Group tree

...
import com.kava.kbpd.upms.trigger.converter.SysOauthClientDetailsTriggerConverter;
...
public class SysOauthClientDetailsController {
    ...
    @Resource
    private SysOauthClientDetailsTriggerConverter sysOauthClientDetailsTriggerConverter;

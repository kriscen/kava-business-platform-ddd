...
public interface ISysI18nAppService {
    SysI18nMessageId createI18n(SysI18nCreateCommand command);

    void updateI18n(SysI18nUpdateCommand command);

    void removeI18nBatchByIds(List<SysI18nMessageId> ids);

    PagingInfo<SysI18nAppListDTO> queryI18nPage(SysI18nListQuery query);

    SysI18nAppDetailDTO queryI18nById(SysI18nMessageId id);
}

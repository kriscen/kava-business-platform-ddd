...
@AllArgsConstructor
@NoArgsConstructor
public class SysOauthClientDetailsEntity implements Entity<SysOauthClientDetailsId> {


	private SysOauthClientDetailsId id;
	...
	@Override
	public SysOauthClientDetailsId identifier() {
		return id;
	}
}
